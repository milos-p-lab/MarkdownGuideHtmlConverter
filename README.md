...
- 🧩 **Same API design** — one method: `HtmlMd.ToMarkdown(string html)`
...
✅ Designed to match the Markdown output format already supported by `Markdown.ToHtml`, ensuring **reversible conversions** for supported syntax.
