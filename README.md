...
- 🔄 **Round-trip compatibility** — designed to work with HTML generated by the Markdown converter
...
- 🧩 **Same API design** — one method: `ConvHtmlMarkdown.ToMarkdown(string html)`
...
✅ Designed to match the Markdown output format already supported by `ConvHtmlMarkdown.ToMarkdown`, ensuring **reversible conversions** for supported syntax.

📅 **Status**: Early prototype under testing — will be released in a future version once stable.
